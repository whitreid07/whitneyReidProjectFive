  ...
  return (
    <form onSubmit={props.getRecipes}>
      <div className="formContainer">
        ...
        <button className="formButton">Find Recipe  <i aria-hidden="true" title="Down arrow icon let's user know to go down or more to see" className="fas fa-arrow-circle-down"></i>
